  ...
  class App extends Component {
    ...
    render() {  
      ...
      return (
        <Router>
          <div>
            <Route exact path="/WebDev_Assignment_4/" render={HomeComponent}/>
            <Route exact path="/WebDev_Assignment_4/userProfile" render={UserProfileComponent}/>
            <Route exact path="/WebDev_Assignment_4/login" render={LogInComponent}/>
            <Route exact path="/WebDev_Assignment_4/credits" render={CreditComponent}/>
            <Route exact path="/WebDev_Assignment_4/debits" render={DebitComponent}/>
          </div>
        </Router>
      );
    }
