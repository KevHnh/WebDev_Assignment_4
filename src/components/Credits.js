                    ...
                    {/* route buttons */}
                     <div className="creditHeader">
                        <div className="creditHeader_left">
                            <button onClick={(e) => {this.creditUpdate(e, '/WebDev_Assignment_4/')}} className="credit_homeButton">Home</button>
                        </div>
            
                        <div className="creditHeader_right">
                            <button onClick={(e) => {this.creditUpdate(e, "/WebDev_Assignment_4/userProfile")}} className="credit_linkButton">User Profile</button>
            
                            <button onClick={(e) => {this.creditUpdate(e, "/WebDev_Assignment_4/login")}} className="credit_linkButton">Login</button>
            
                            <button  onClick={(e) => {this.creditUpdate(e, "/WebDev_Assignment_4/credits")}} className="credit_linkButton">Credits</button>
            
                            <button  onClick={(e) => {this.creditUpdate(e, "/WebDev_Assignment_4/debits")}} className="credit_linkButton">Debits</button>
                        </div>
                    </div>
