                ...
                <div className='debitsMain'>
                    ...
                    <div className="debitHeader">
                        <div className="debitHeader_left">
                            <button onClick={(e) => {this.debitUpdate(e, '/WebDev_Assignment_4/')}} className="debit_homeButton">Home</button>
                        </div>
            
                        <div className="debitHeader_right">
                            <button onClick={(e) => {this.debitUpdate(e, "/WebDev_Assignment_4/userProfile")}} className="debit_linkButton">User Profile</button>
            
                            <button onClick={(e) => {this.debitUpdate(e, "/WebDev_Assignment_4/login")}} className="debit_linkButton">Login</button>
            
                            <button  onClick={(e) => {this.debitUpdate(e, "/WebDev_Assignment_4/credits")}} className="debit_linkButton">Credits</button>
            
                            <button  onClick={(e) => {this.debitUpdate(e, "/WebDev_Assignment_4/debits")}} className="debit_linkButton">Debits</button>
                        </div>
                    </div>
